...
<head>
  <title>已发送</title>
  <link rel="stylesheet" type="text/css" media="screen" href="${ctx}/static/js/jquery-ui/jquery-ui.css"/>
...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <a href="${ctx}/message/write">已发送</a>
    </li>
  </ul>
</div>
<div class="row">
...
<script language="JavaScript">
  ...
  $(function(){
      ...
      $("#jqgridTable").jqGrid({
        url: ctx+'/message/send',
        datatype: "json",
        mtype: "POST",
        colNames: ['id','接收人', '主题', '内容', '发送时间', '状态','操作'],
        colModel: [
          {name: 'id', index: 'id',hidden:true,align:'center',width:'25px'},
          {name: 'toUser', index: 'toUser', align: 'center', width: '150px'},
          ...
          {
            name: 'fromStatus', index: 'toStatus', align: 'center', width: '150px',
            formatter:function(v){
              var s="已发送";
              if('0'==v)
              s="已删除";
  ...
  function deleteMessage(obj){
    ...
    $.post(ctx+'/message/deleteMessage2',{id:id},function(date){
      if('success'==date.msg){
